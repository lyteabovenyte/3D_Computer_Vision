...
class KeypointEncoder(nn.Module):
    ...
    def soft_argmax(self, heatmaps):
        """args: 
            heatmaps (N, K, H, W):  the discriptor image of the input image

        """
        N, K, H, W = heatmaps.shape
        heatmaps = heatmaps.view(N, K, -1)
        # Each “pixel” inside a heatmap corresponds to a score of how 
        # “likely” that pixel is to be the location of the keypoint.
        # We can use softmax to normalize the scores.
        ...
        # soft_argmax operation: essential for end-to-end training
